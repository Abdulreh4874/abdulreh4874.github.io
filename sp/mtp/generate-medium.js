...
function generate() {
        ...
        document.getElementById("desc").innerHTML = "The preview for your custom music player isn't viewable here, but it will appear as above and play correctly once installed.<br><br><b>First code:</b> Click once in the white box to select the script, then copy and paste it in your own code after <code>/body</code><br><br><b>Second code:</b> This is where you can add any amount of audio. Positioning and audio help are provided in the code comments. Paste this in your code after <code>body</code><br><br><span>💬 For additional support, reach me <a href = 'mailto:maddie.kahlon@proton.me'  target= '_blank'>here</a>.</span>";
        ...
        (function() {
                ...
                document.getElementById("code1").innerHTML = "&lt;script src&equals;&quot;https://scriptest.github.io/sp/mtp/multituneplayer-medium.js&quot;&gt;&lt;&sol;script&gt;";
