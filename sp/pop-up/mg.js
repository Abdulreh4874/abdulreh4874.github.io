...
function test() {
        ...
        var lettertext = document.getElementById("coral-txt").value;
...
function cod() {
        ...
        document.getElementById("stylecode").innerHTML = "#mailboxcage &lcub; position: fixed; bottom: 22px; left: 32px; z-index: 9999999; height: 82px; width: 62px; display: block; &rcub;" + "<br /><br />" + "#mailbox &lcub; cursor: pointer; &rcub;" + "<br /><br />" + "#envelope &lcub; position: absolute; width: 60px; height: 80px; background: " + senvelope + "; border-left: 1px solid " + sborders + "; border-right: 1px solid " + sborders + "; border-bottom: 1px solid " + sborders + "; border-top: 1px solid " + sborders + "; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px; overflow: hidden; box-shadow: 4px 4px 1px " + sshadow + "; z-index: 10; &rcub;" + "<br /><br />" + "#middleline &lcub; height: 80px; width: 1px; background: " + sborders + "; position: absolute; margin: 0 0 0 29px; opacity: 0.5; &rcub;" + "<br /><br />" + "#intriangle &lcub; position: absolute; width: 60px; height: 60px; border: 1px solid " + sborders + "; -webkit-border-radius: 15px; -moz-border-radius: 15px; border-radius: 15px; background: " + senvelope + "; margin: -39px 0 0 -1px; -ms-transform: rotate(45deg); -webkit-transform: rotate(45deg); transform: rotate(45deg); &rcub;" + "<br /><br />" + "#outtriangle &lcub; position: absolute; margin: -20px 0 0 5px; width: 50px; height: 50px; border: 1px solid " + sborders + "; -webkit-border-radius: 15px; -moz-border-radius: 15px; border-radius: 15px; background: " + senvelope + "; -ms-transform: rotate(45deg); -webkit-transform: rotate(45deg); transform: rotate(45deg); z-index: 8; opacity: 0; &rcub;" + "<br /><br />" + "#paper &lcub; position: absolute; z-index: 9; margin: -15px 0 0 0; width: 60px; height: 40px; border: 1px solid " + sborders + "; background: " + spaper + "; -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px; opacity: 0; overflow: hidden; &rcub;" + "<br /><br />" + ".paperline &lcub; width: 40px; height: 1px; background: " + spaperlines + "; margin: 4px 0 -2px 10px; &rcub;" + "<br /><br />" + "#bigpapercontainer &lcub; position: absolute; margin: -125px 0 0 100px; opacity: 0; transition: all 0.5s ease-in-out; &rcub;" + "<br /><br />" + "#bigpaper &lcub; border: 1px solid " + sborders + "; background: " + spaper + "; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px; box-shadow: 4px 4px 1px " + sshadow + "; overflow: hidden; width: 120px; height: 160px; &rcub;" + "<br /><br />" + "#bigpapertext &lcub; position: absolute; z-index: 11; margin: 5px 0 0 10px; font-family: arial; font-size: 10px; line-height: 13px; overflow: hidden; color: " + sfont + "; width: 100px; height: 140px; &rcub;" + "<br /><br />" + ".bigpaperline &lcub; width: 120px; height: 1px; background: " + spaperlines + "; margin-top: 7px; &rcub;" + "<br /><br />" + "#coverletter &lcub; position: absolute; width: 130px; height: 170px; margin: -125px 0 0 100px; opacity: 0; &rcub;" + "<br /><br />" + "#mailbox:hover #outtriangle &lcub; opacity: 1; &rcub;" + "<br /><br />" + "#mailbox:hover #intriangle &lcub; background: " + spaper + "; margin: -43px 0 0 -1px; border-radius: 20px; &rcub;" + "<br /><br />" + "#mailbox:hover #envelope &lcub; border-top: 1px solid " + spaper + "; &rcub;" + "<br /><br />" + "#mailbox:hover #paper &lcub; opacity: 1; &rcub;" + "<br /><br />" + "#mailbox:hover #bigpapercontainer &lcub; opacity: 1; margin: -130px 0 0 100px; &rcub;";
